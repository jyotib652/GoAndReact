...
export default class AppClass extends Component {
    constructor(props) {
        ...
        this.lastNameRef = React.createRef(); // this one is being handled not in this component(this page) but in Input component
        this.firstNameRef = React.createRef();
        this.dobRef = React.createRef(null); // this one is being handled not in this component(this page) but in Input component
    ...
    addPerson(newFirst, newLast, newDob) {
        ...
        // to clear the values from the web page after submitting
        this.setState({ firstName: "", lastName: "", dob: "" })

        // to clear the values from the input fields after submitting
        this.firstNameRef.current.value = "";
        this.lastNameRef.current.value = "";
        this.dobRef.current.value = "";
    }

    // this one is part of React
    // when component mounts we want to modify crowd.
    // here, we're simulating fetching value from api like
    //  we did with useEffect() hook in functional component
    componentDidMount() {
        this.setState({
            firstName: "",
            lastName: "",
